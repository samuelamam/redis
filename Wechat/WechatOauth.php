...
class WechatOauth extends WechatCommon {
    ...
    const OAUTH_PREFIX_PC = 'https://open.weixin.qq.com/connect/qrconnect?';
     ...
     * @return string
     */
    public function getOauthRedirect($callback, $state = '', $scope = 'snsapi_base', $sw = '') {
        $redirect_uri = urlencode($callback);
        switch ($sw) {
            case 'pc':
                return self::OAUTH_PREFIX_PC . "appid={$this->appid}&redirect_uri={$redirect_uri}&response_type=code&scope=snsapi_login&state=STATE#wechat_redirect";
                break;
